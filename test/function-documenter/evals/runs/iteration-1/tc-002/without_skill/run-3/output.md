...
/// </summary>
/// <param name="enemyType">The type of enemy to spawn (e.g., "goblin", "orc", "dragon").</param>
/// <param name="position">The world position where the enemy will be instantiated.</param>
/// <param name="health">The initial health value for the enemy.</param>
/// <param name="isBoss">Whether the enemy is a boss enemy with special behavior.</param>
